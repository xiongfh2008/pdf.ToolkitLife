/*
 * coherentpdf.global.d.ts — TypeScript type definitions for PDFToolkit / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the PDFToolkit project.
