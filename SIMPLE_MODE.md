...
```bash
docker run -p 3000:8080 pdftoolkit/pdftoolkit-simple:latest
```

**Using GitHub Container Registry:**

```bash
docker run -p 3000:8080 ghcr.io/alam00000/pdftoolkit-simple:latest
```
...
services:
  pdftoolkit:
    # Using Docker Hub
    image: pdftoolkit/pdftoolkit-simple:latest
    # Or using GitHub Container Registry
    # image: ghcr.io/alam00000/pdftoolkit-simple:latest
...
```bash
docker build --build-arg SIMPLE_MODE=true -t pdftoolkit-simple .
docker run -p 3000:8080 pdftoolkit-simple
```
...
docker pull pdftoolkit/pdftoolkit-simple:latest
docker run -p 3000:8080 pdftoolkit/pdftoolkit-simple:latest
```
...
```bash
# Test Normal Mode
docker run -p 3000:8080 pdftoolkit/pdftoolkit:latest

# Test Simple Mode
docker run -p 3001:8080 pdftoolkit/pdftoolkit-simple:latest
```
...
- `pdftoolkit/pdftoolkit:latest`
- `pdftoolkit/pdftoolkit:v1.0.0` (versioned)

**GitHub Container Registry:**

- `ghcr.io/alam00000/pdftoolkit:latest`
- `ghcr.io/alam00000/pdftoolkit:v1.0.0` (versioned)

### Simple Mode (Clean Interface)

**Docker Hub:**

- `pdftoolkit/pdftoolkit-simple:latest`
- `pdftoolkit/pdftoolkit-simple:v1.0.0` (versioned)

**GitHub Container Registry:**

- `ghcr.io/alam00000/pdftoolkit-simple:latest`
- `ghcr.io/alam00000/pdftoolkit-simple:v1.0.0` (versioned)
...
- **Pre-built images**: Use `pdftoolkit/pdftoolkit-simple:latest` for Simple Mode
